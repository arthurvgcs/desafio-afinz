...
export default function TransferForm() {
  ...
  const { agency, account, balance, setBalance } = useBalanceContext();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await accountService.consultAgencyAndAccount(
        Number(agencyTransfer),
          ...
          <div className={styles.formGroup}>
            ...
            <div className={styles.selectWrapper}>
              <select
                ...
                disabled
              >
                <option value="TED (Transferência entre contas)">
          ...
          <div className={styles.formGroup}>
            ...
            <input
              ...
              className={`${styles.input} ${
                agencyError ? styles.inputError : ""
              }`}
              value={agencyTransfer}
